/**
 * Implementation of public facing functions in gaia_spdlog_setup.
...
/**
 * Performs gaia_spdlog configuration setup from file, with tag values to be
...
/**
 * Performs gaia_spdlog configuration setup from both base and override files, with
...
/**
 * Performs gaia_spdlog configuration setup from file.
...
/**
 * Performs gaia_spdlog configuration setup from both base and override files. The
 * base file is required while the override file is optional.
