...
/** Windows error */
struct win32_error : public gaia_spdlog_ex
{
    ...
    explicit win32_error(std::string const &func_name, DWORD error = GetLastError())
        : gaia_spdlog_ex(format(func_name, error))
    {}
};
...
public:
    ...
    static sid_t duplicate_sid(PSID psid)
    {
        ...
        {
            GAIA_SPDLOG_THROW(win32_error("CopySid"));
        }
    ...
    static sid_t get_current_user_sid()
    {
        ...
        struct process_token_t
        {
            ...
            explicit process_token_t(HANDLE process)
            {
                ...
                {
                    GAIA_SPDLOG_THROW(win32_error("OpenProcessToken"));
                }
            }
        ...
        {
            GAIA_SPDLOG_THROW(win32_error("GetTokenInformation should fail"));
        }
        ...
        {
            GAIA_SPDLOG_THROW(win32_error("GetTokenInformation"));
        }
...
private:
    ...
    HANDLE event_log_handle()
    {
        if (!hEventLog_)
        {
            ...
            {
                GAIA_SPDLOG_THROW(internal::win32_error("RegisterEventSource"));
            }
        }
...
protected:
    void sink_it_(const details::log_msg &msg) override
    {
        ...
        if (!succeeded)
        {
            GAIA_SPDLOG_THROW(win32_error("ReportEvent"));
        }
    }
