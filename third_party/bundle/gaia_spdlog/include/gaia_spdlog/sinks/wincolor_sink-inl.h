...
GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::wincolor_sink(void *out_handle, color_mode mode)
...
template<typename ConsoleMutex>
GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::~wincolor_sink()
{
    this->flush();
}
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_color(level::level_enum level, std::uint16_t color)
{
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::log(const details::log_msg &msg)
{
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::flush()
{
    // windows console always flushed?
}

template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_pattern(const std::string &pattern)
{
    std::lock_guard<mutex_t> lock(mutex_);
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_formatter(std::unique_ptr<gaia_spdlog::formatter> sink_formatter)
{
    std::lock_guard<mutex_t> lock(mutex_);
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_color_mode(color_mode mode)
{
    std::lock_guard<mutex_t> lock(mutex_);
    set_color_mode_impl(mode);
}
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_color_mode_impl(color_mode mode)
{
...
template<typename ConsoleMutex>
std::uint16_t GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::set_foreground_color_(std::uint16_t attribs)
{
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::print_range_(const memory_buf_t &formatted, size_t start, size_t end)
{
    if (end > start)
    {
...
template<typename ConsoleMutex>
void GAIA_SPDLOG_INLINE wincolor_sink<ConsoleMutex>::write_to_file_(const memory_buf_t &formatted)
{
...
template<typename ConsoleMutex>
GAIA_SPDLOG_INLINE wincolor_stdout_sink<ConsoleMutex>::wincolor_stdout_sink(color_mode mode)
    : wincolor_sink<ConsoleMutex>(::GetStdHandle(STD_OUTPUT_HANDLE), mode)
{}

// wincolor_stderr_sink
template<typename ConsoleMutex>
GAIA_SPDLOG_INLINE wincolor_stderr_sink<ConsoleMutex>::wincolor_stderr_sink(color_mode mode)
