...
#include <gaia_spdlog/formatter.h>
...
GAIA_SPDLOG_INLINE pattern_formatter::pattern_formatter(
...
GAIA_SPDLOG_INLINE pattern_formatter::pattern_formatter(pattern_time_type time_type, std::string eol)
    : pattern_("%+")
    , eol_(std::move(eol))
    , pattern_time_type_(time_type)
    , last_log_secs_(0)
...
GAIA_SPDLOG_INLINE std::unique_ptr<formatter> pattern_formatter::clone() const
{
...
GAIA_SPDLOG_INLINE void pattern_formatter::format(const details::log_msg &msg, memory_buf_t &dest)
{
...
GAIA_SPDLOG_INLINE std::tm pattern_formatter::get_time_(const details::log_msg &msg)
{
...
GAIA_SPDLOG_INLINE void pattern_formatter::handle_flag_(char flag, details::padding_info padding)
{
    ...
    default: // Unknown flag appears as is
        ...
        // gaia_spdlog::set_pattern("[%10!] %v") => "[      main] some message"
        // gaia_spdlog::set_pattern("[%3!!] %v") => "[mai] some message"
        else
        {
...
// Return padding.
GAIA_SPDLOG_INLINE details::padding_info pattern_formatter::handle_padspec_(std::string::const_iterator &it, std::string::const_iterator end)
{
...
GAIA_SPDLOG_INLINE void pattern_formatter::compile_pattern_(const std::string &pattern)
{
