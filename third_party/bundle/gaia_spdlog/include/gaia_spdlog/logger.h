...
#include <vector>
#ifndef GAIA_SPDLOG_NO_EXCEPTIONS
#define GAIA_SPDLOG_LOGGER_CATCH()                                                                                                              \
...
public:
    ...
    logger(logger &&other) GAIA_SPDLOG_NOEXCEPT;
    logger &operator=(logger other) GAIA_SPDLOG_NOEXCEPT;
    ...
    template<class T, typename std::enable_if<!std::is_convertible<const T &, gaia_spdlog::string_view_t>::value &&
...
protected:
    ...
    gaia_spdlog::level_t level_{level::info};
    gaia_spdlog::level_t flush_level_{level::off};
