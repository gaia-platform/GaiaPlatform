...
// An attempt to create a logger with an already existing name will result with gaia_spdlog_ex exception.
...
class GAIA_SPDLOG_API registry
{
public:
...
private:
    ...
    gaia_spdlog::level::level_enum global_log_level_ = level::info;
