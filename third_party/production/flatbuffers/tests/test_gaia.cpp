...
#include "addr_book_col_events_no_iud_events_gaia_generated.h"
#include "addr_book_no_col_events_gaia_generated.h"
#include "addr_book_no_table_events_tx_event_gaia_generated.h"
...
int64_t create_employee_no_iud_events(int64_t Gaia_Mgr_id_val, int64_t Gaia_FirstAddr_id_val, int64_t Gaia_FirstPhone_id_val, 
    int64_t Gaia_FirstProvision_id_val, int64_t Gaia_FirstSalary_id_val, const char *name_first_val, 
    const char *name_last_val, const char *ssn_val, int64_t hire_date_val, const char *email_val, 
    const char *web_val)
{
    auto employee = new Addr_Book_Col_Events_No_IUD_Events::Employee();
    employee->set_Gaia_Mgr_id(Gaia_Mgr_id_val);
    employee->set_Gaia_FirstAddr_id(Gaia_FirstAddr_id_val);
    employee->set_Gaia_FirstPhone_id(Gaia_FirstPhone_id_val);
    employee->set_Gaia_FirstProvision_id(Gaia_FirstProvision_id_val);
...
int64_t create_employee_no_col_events(int64_t Gaia_Mgr_id_val, int64_t Gaia_FirstAddr_id_val, int64_t Gaia_FirstPhone_id_val, 
    int64_t Gaia_FirstProvision_id_val, int64_t Gaia_FirstSalary_id_val, const char *name_first_val, 
    const char *name_last_val, const char *ssn_val, int64_t hire_date_val, const char *email_val, 
    const char *web_val)
{
    auto employee = new Addr_Book_No_Col_Events::Employee();
    employee->set_Gaia_Mgr_id(Gaia_Mgr_id_val);
    employee->set_Gaia_FirstAddr_id(Gaia_FirstAddr_id_val);
    employee->set_Gaia_FirstPhone_id(Gaia_FirstPhone_id_val);
    employee->set_Gaia_FirstProvision_id(Gaia_FirstProvision_id_val);
...
int64_t create_employee_no_table_tx_events(int64_t Gaia_Mgr_id_val, int64_t Gaia_FirstAddr_id_val, int64_t Gaia_FirstPhone_id_val, 
    int64_t Gaia_FirstProvision_id_val, int64_t Gaia_FirstSalary_id_val, const char *name_first_val, 
    const char *name_last_val, const char *ssn_val, int64_t hire_date_val, const char *email_val, 
    const char *web_val)
{
    auto employee = new Addr_Book_No_table_Events_Tx_Event::Employee();
    employee->set_Gaia_Mgr_id(Gaia_Mgr_id_val);
    employee->set_Gaia_FirstAddr_id(Gaia_FirstAddr_id_val);
    employee->set_Gaia_FirstPhone_id(Gaia_FirstPhone_id_val);
    employee->set_Gaia_FirstProvision_id(Gaia_FirstProvision_id_val);
...
{
    Addr_Book_No_Col_Events::Employee::begin_transaction();
    ...
    int64_t empl_node_id = create_employee_no_col_events(manager_id
        ,first_address_id
        ,first_phone_id
        ,first_provision_id
        ,first_salary_id
    ...
    Addr_Book_No_Col_Events::Employee *pEmployee = Addr_Book_No_Col_Events::Employee::get_row_by_id(empl_node_id);

    pEmployee->set_ssn("test");
    TEST_EQ_STR("test",pEmployee->ssn());
    TEST_EQ(g_event_type,gaia::rules::event_type_t::row_insert);
    TEST_EQ(g_event_mode,gaia::rules::event_mode_t::immediate);
    TEST_EQ(g_gaia_type, Addr_Book_No_Col_Events::kEmployeeType);
    TEST_EQ(g_table_context, pEmployee);
    
    Addr_Book_No_Col_Events::Employee::commit_transaction();
...
{
    Addr_Book_Col_Events_No_IUD_Events::Employee::begin_transaction();
    ...
    int64_t empl_node_id = create_employee_no_iud_events(manager_id
        ,first_address_id
        ,first_phone_id
        ,first_provision_id
        ,first_salary_id
    ...
    Addr_Book_Col_Events_No_IUD_Events::Employee *pEmployee = Addr_Book_Col_Events_No_IUD_Events::Employee::get_row_by_id(empl_node_id);

    pEmployee->set_ssn("test");
    TEST_EQ_STR("test",pEmployee->ssn());
    TEST_EQ(g_event_type,gaia::rules::event_type_t::col_change);
    TEST_EQ(g_event_mode,gaia::rules::event_mode_t::immediate);
    TEST_EQ(g_gaia_type, Addr_Book_Col_Events_No_IUD_Events::kEmployeeType);
    TEST_EQ(g_table_context, pEmployee);
    ...
    TEST_EQ(g_gaia_type, Addr_Book_Col_Events_No_IUD_Events::kEmployeeType);
    TEST_EQ(g_table_context, pEmployee);
    Addr_Book_Col_Events_No_IUD_Events::Employee *pEmployee1 = Addr_Book_Col_Events_No_IUD_Events::Employee::get_row_by_id(empl_node_id);
    TEST_EQ_STR("test",pEmployee1->ssn());

    Addr_Book_Col_Events_No_IUD_Events::Employee::commit_transaction();
...
{
    Addr_Book_No_table_Events_Tx_Event::Employee::begin_transaction();
    ...
    int64_t empl_node_id = create_employee_no_table_tx_events(manager_id
        ,first_address_id
        ,first_phone_id
        ,first_provision_id
        ,first_salary_id
    ...
    Addr_Book_No_table_Events_Tx_Event::Employee *pEmployee = Addr_Book_No_table_Events_Tx_Event::Employee::get_row_by_id(empl_node_id);

    pEmployee->set_ssn("test");
    TEST_EQ_STR("test",pEmployee->ssn());
    TEST_EQ(g_event_type,gaia::rules::event_type_t::col_change);
    TEST_EQ(g_event_mode,gaia::rules::event_mode_t::immediate);
    TEST_EQ(g_gaia_type, Addr_Book_No_table_Events_Tx_Event::kEmployeeType);
    TEST_EQ(g_table_context, pEmployee);
    
    Addr_Book_No_table_Events_Tx_Event::Employee::commit_transaction();
    TEST_EQ(g_event_type,gaia::rules::event_type_t::col_change);
    TEST_EQ(g_event_mode,gaia::rules::event_mode_t::immediate);
}
