        ...
        private:
            ...
            {                
                ...
                if (opts_.generate_setters && opts_.generate_events)
                {
                    ...
                    "   }\n"
                    "   gaia::db::triggers::trigger_event_t event = {gaia::db::triggers::event_type_t::row_update, this->container_id(),\n"
                    ...
                    "   gaia::db::triggers::trigger_event_t event = {gaia::db::triggers::event_type_t::row_insert, this->container_id(),\n"
                    ...
                    "   gaia::db::triggers::trigger_event_t event = {gaia::db::triggers::event_type_t::row_delete, this->container_id(),\n"
                    "       this->gaia_id(), empty_position_list};\n"
                    "}";
