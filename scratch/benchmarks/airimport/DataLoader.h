...
class AirportData
{
    public:
        ...
        bool _load(const char * filename, 
            function<void (flatbuffers::FlatBufferBuilder&, CSVRow &)> loader)
        {
        ...
        bool load_airlines()
        {
            _load(string(_data_path).append("airlines.dat").c_str(),
                [&](flatbuffers::FlatBufferBuilder& b, CSVRow& row)
                {
                    ...
                    // raw flatbuffer API
                    b.Finish(CreateairlinesDirect(b, _node_id, 0, 0,
                        al_id, // al_id
                    ...
                    gaia_se_node::create(_node_id, AirportDemo::kAirlinesType, b.GetSize(), b.GetBufferPointer());
        ...
        bool load_airports()
        {
            _load(string(_data_path).append("airports.dat").c_str(), 
                [&](flatbuffers::FlatBufferBuilder& b, CSVRow& row)
                {
                    ...
                    // raw flatbuffer API
                    b.Finish(CreateairportsDirect(b, _node_id, 0, 0,
                        ap_id, // api_id
                        row[1].is_null ? 0 : row[1].col.c_str(), // name
                    ...
                    gaia_se_node::create(_node_id, AirportDemo::kAirportsType, b.GetSize(), b.GetBufferPointer());
        ...
        bool load_routes()
        {
                ...
                [&](flatbuffers::FlatBufferBuilder& b, CSVRow& row)
                {
                    ...
                    {
                        // raw flatbuffer API
                        b.Finish(CreateroutesDirect(b, _node_id, 0, 0, gaia_al_id, gaia_src_id, gaia_dst_id,
                        ...
                        gaia_se_edge::create(_node_id, AirportDemo::kRoutesType, gaia_src_id, gaia_dst_id, 
