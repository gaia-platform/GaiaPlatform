...
static string generate_boilerplate_top(string dbname) {
    ...
    code += "/////////////////////////////////////////////";
    code += "";
    code += "// Automatically generated by Gaia EDC code generator, do not modify.";
    code += "";
    ...
    references_vec& references_1, references_vec& references_N)
{
    ...
    for (auto f : field_strings) {
        ...
        if (f.type == gaia_data_type_STRING) {
            ...
            code.set_value("FCN_NAME_ORIGINAL", "GET_STR_ORIGINAL");
        }
        else {
            code.set_value("FCN_NAME", "GET_CURRENT");
            code.set_value("FCN_NAME_ORIGINAL", "GET_ORIGINAL");
        }
        code += "{{TYPE}} {{FIELD_NAME}}() const {return {{FCN_NAME}}({{FIELD_NAME}});}";
        code += "{{TYPE}} {{FIELD_NAME}}_original() const {return {{FCN_NAME_ORIGINAL}}({{FIELD_NAME}});}";
    ...
    code += param_list + ") {";
    code.increment_indent_level();
    code += "flatbuffers::FlatBufferBuilder b(128);";
