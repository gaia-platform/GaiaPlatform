...
TEST(catalog_ddl_parser_test, create_table_references) {
    ...
    EXPECT_EQ(create_stmt->type, create_type_t::create_table);
    EXPECT_EQ(create_stmt->name, "t");
    EXPECT_EQ(create_stmt->fields.size(), 3);
    ...
    EXPECT_EQ(create_stmt->fields.at(1)->length, 3);

    EXPECT_EQ(create_stmt->fields.at(2)->name, "c3");
    EXPECT_EQ(create_stmt->fields.at(2)->type, data_type_t::e_references);
    EXPECT_EQ(create_stmt->fields.at(2)->length, 0);
}
