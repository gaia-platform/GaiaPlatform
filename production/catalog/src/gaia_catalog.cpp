...
gaia::direct_access::edc_vector_t<uint16_t> gaia_relationship_t::parent_field_positions() const {
    return GET_ARRAY(parent_field_positions);
}
gaia::direct_access::edc_vector_t<uint16_t> gaia_relationship_t::child_field_positions() const {
