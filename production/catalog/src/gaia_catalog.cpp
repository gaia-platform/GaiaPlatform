...
gaia_relationship_t rule_relationship_t::relationship() const {
    return gaia_relationship_t::get(this->references()[c_rule_relationship_parent_relationship]);
}
gaia_rule_t rule_relationship_t::rule() const {
    return gaia_rule_t::get(this->references()[c_rule_relationship_parent_rule]);
}
//
...
gaia_field_t rule_field_t::field() const {
    return gaia_field_t::get(this->references()[c_rule_field_parent_field]);
}
gaia_rule_t rule_field_t::rule() const {
    return gaia_rule_t::get(this->references()[c_rule_field_parent_rule]);
}
//
...
gaia_table_t rule_table_t::table() const {
    return gaia_table_t::get(this->references()[c_rule_table_parent_table]);
}
gaia_rule_t rule_table_t::rule() const {
    return gaia_rule_t::get(this->references()[c_rule_table_parent_rule]);
}
//
...
gaia_ruleset_t ruleset_database_t::ruleset() const {
    return gaia_ruleset_t::get(this->references()[c_ruleset_database_parent_ruleset]);
}
gaia_database_t ruleset_database_t::database() const {
    return gaia_database_t::get(this->references()[c_ruleset_database_parent_database]);
}
//
...
gaia_ruleset_t app_ruleset_t::ruleset() const {
    return gaia_ruleset_t::get(this->references()[c_app_ruleset_parent_ruleset]);
}
gaia_application_t app_ruleset_t::application() const {
    return gaia_application_t::get(this->references()[c_app_ruleset_parent_application]);
}
//
...
gaia_database_t app_database_t::database() const {
    return gaia_database_t::get(this->references()[c_app_database_parent_database]);
}
gaia_application_t app_database_t::application() const {
    return gaia_application_t::get(this->references()[c_app_database_parent_application]);
}
//
...
gaia::common::gaia_id_t gaia_relationship_t::insert_row(const char* name, const char* to_parent_link_name, const char* to_child_link_name, uint8_t cardinality, bool parent_required, bool deprecated, uint16_t first_child_offset, uint16_t next_child_offset, uint16_t parent_offset, const std::vector<uint16_t>& parent_field_positions, const std::vector<uint16_t>& child_field_positions, const char* hash) {
    flatbuffers::FlatBufferBuilder b(c_flatbuffer_builder_size);
    b.Finish(internal::Creategaia_relationshipDirect(b, name, to_parent_link_name, to_child_link_name, cardinality, parent_required, deprecated, first_child_offset, next_child_offset, parent_offset, &parent_field_positions, &child_field_positions, hash));
    return dac_object_t::insert_row(b);
}
