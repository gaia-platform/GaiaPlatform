...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_rule_relationship_parent_relationship];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_relationship_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_rule_relationship_parent_rule];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_rule_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_rule_field_parent_field];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_field_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_rule_field_parent_rule];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_rule_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_rule_table_parent_table];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_table_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_rule_table_parent_rule];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_rule_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_ruleset_database_parent_ruleset];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_ruleset_database_parent_database];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_app_ruleset_parent_ruleset];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_ruleset_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_app_ruleset_parent_application];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_application_t();
    }
    gaia::common::gaia_id_t id = dac_db_t::get_reference(anchor_id, gaia::common::c_ref_anchor_parent_offset);
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_app_database_parent_database];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_database_t();
    }
...
{
    gaia::common::gaia_id_t anchor_id = this->references()[c_app_database_parent_application];
    if (anchor_id == gaia::common::c_invalid_gaia_id)
    {
        return gaia_application_t();
    }
