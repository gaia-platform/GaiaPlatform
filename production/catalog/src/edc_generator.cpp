...
const std::string c_indent_string("    ");
...
std::string edc_compilation_unit_writer_t::write_header()
{
    ...
    code += generate_edc_ref_forward_declarations();
...
std::string edc_compilation_unit_writer_t::generate_cpp_includes()
{
...
std::string edc_compilation_unit_writer_t::generate_edc_forward_declarations()
{
    flatbuffers::CodeWriter code = create_code_writer();
...
std::string edc_compilation_unit_writer_t::generate_edc_ref_forward_declarations()
{
    flatbuffers::CodeWriter code = create_code_writer();
...
std::string class_writer_t::generate_fields_accessors_cpp()
{
    ...
    for (const auto& field : m_table.fields())
    {
        ...
        code.IncrementIdentLevel();
        code += "return {{FCN_NAME}}({{FIELD_NAME}});";
        code.DecrementIdentLevel();
        code += "}";
    }
