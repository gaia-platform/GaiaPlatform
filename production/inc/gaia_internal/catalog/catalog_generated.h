...
struct rule_fieldBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_gaia_rule(flatbuffers::Offset<flatbuffers::String> gaia_rule) {
    fbb_.AddOffset(rule_field::VT_GAIA_RULE, gaia_rule);
  }
  void add_gaia_field_id(uint64_t gaia_field_id) {
...
struct rule_tableBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_gaia_rule(flatbuffers::Offset<flatbuffers::String> gaia_rule) {
    fbb_.AddOffset(rule_table::VT_GAIA_RULE, gaia_rule);
  }
...
struct ruleset_databaseT : public flatbuffers::NativeTable {
  ...
  gaia::direct_access::nullable_string_t gaia_ruleset{};
...
struct ruleset_database FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::String *gaia_ruleset() const {
    return GetPointer<const flatbuffers::String *>(VT_GAIA_RULESET);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_GAIA_RULESET) &&
           verifier.VerifyString(gaia_ruleset()) &&
...
struct ruleset_databaseBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_gaia_ruleset(flatbuffers::Offset<flatbuffers::String> gaia_ruleset) {
    fbb_.AddOffset(ruleset_database::VT_GAIA_RULESET, gaia_ruleset);
  }
...
inline flatbuffers::Offset<ruleset_database> Createruleset_database(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> gaia_ruleset = 0,
    uint64_t gaia_database_id = 0) {
  ruleset_databaseBuilder builder_(_fbb);
  builder_.add_gaia_database_id(gaia_database_id);
  builder_.add_gaia_ruleset(gaia_ruleset);
  return builder_.Finish();
}

inline flatbuffers::Offset<ruleset_database> Createruleset_databaseDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const char *gaia_ruleset = nullptr,
    uint64_t gaia_database_id = 0) {
  auto gaia_ruleset__ = gaia_ruleset ? _fbb.CreateString(gaia_ruleset) : 0;
...
struct app_rulesetT : public flatbuffers::NativeTable {
  ...
  gaia::direct_access::nullable_string_t gaia_application{};
  gaia::direct_access::nullable_string_t gaia_ruleset{};
...
struct app_ruleset FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_GAIA_APPLICATION = 4,
    VT_GAIA_RULESET = 6,
    VT_ACTIVE_ON_STARTUP = 8
  };
  const flatbuffers::String *gaia_application() const {
    return GetPointer<const flatbuffers::String *>(VT_GAIA_APPLICATION);
  }
  const flatbuffers::String *gaia_ruleset() const {
    return GetPointer<const flatbuffers::String *>(VT_GAIA_RULESET);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_GAIA_APPLICATION) &&
           verifier.VerifyString(gaia_application()) &&
           VerifyOffset(verifier, VT_GAIA_RULESET) &&
           verifier.VerifyString(gaia_ruleset()) &&
...
struct app_rulesetBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_gaia_application(flatbuffers::Offset<flatbuffers::String> gaia_application) {
    fbb_.AddOffset(app_ruleset::VT_GAIA_APPLICATION, gaia_application);
  }
  void add_gaia_ruleset(flatbuffers::Offset<flatbuffers::String> gaia_ruleset) {
    fbb_.AddOffset(app_ruleset::VT_GAIA_RULESET, gaia_ruleset);
  }
...
inline flatbuffers::Offset<app_ruleset> Createapp_ruleset(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> gaia_application = 0,
    flatbuffers::Offset<flatbuffers::String> gaia_ruleset = 0,
    bool active_on_startup = false) {
  app_rulesetBuilder builder_(_fbb);
  builder_.add_gaia_ruleset(gaia_ruleset);
  builder_.add_gaia_application(gaia_application);
...
inline flatbuffers::Offset<app_ruleset> Createapp_rulesetDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const char *gaia_application = nullptr,
    const char *gaia_ruleset = nullptr,
    bool active_on_startup = false) {
  auto gaia_application__ = gaia_application ? _fbb.CreateString(gaia_application) : 0;
  auto gaia_ruleset__ = gaia_ruleset ? _fbb.CreateString(gaia_ruleset) : 0;
...
struct app_databaseBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_gaia_application(flatbuffers::Offset<flatbuffers::String> gaia_application) {
    fbb_.AddOffset(app_database::VT_GAIA_APPLICATION, gaia_application);
  }
  void add_gaia_database_id(uint64_t gaia_database_id) {
...
struct gaia_ruleBuilder {
  ...
  void add_gaia_ruleset(flatbuffers::Offset<flatbuffers::String> gaia_ruleset) {
    fbb_.AddOffset(gaia_rule::VT_GAIA_RULESET, gaia_ruleset);
  }
...
inline void ruleset_database::UnPackTo(ruleset_databaseT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = gaia_ruleset(); if (_e) _o->gaia_ruleset = gaia::direct_access::nullable_string_t(_e->c_str(), _e->size()); }
...
inline flatbuffers::Offset<ruleset_database> Createruleset_database(flatbuffers::FlatBufferBuilder &_fbb, const ruleset_databaseT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _gaia_ruleset = _o->gaia_ruleset.empty() ? 0 : _fbb.CreateString(_o->gaia_ruleset);
...
inline void app_ruleset::UnPackTo(app_rulesetT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = gaia_application(); if (_e) _o->gaia_application = gaia::direct_access::nullable_string_t(_e->c_str(), _e->size()); }
  { auto _e = gaia_ruleset(); if (_e) _o->gaia_ruleset = gaia::direct_access::nullable_string_t(_e->c_str(), _e->size()); }
...
inline flatbuffers::Offset<app_ruleset> Createapp_ruleset(flatbuffers::FlatBufferBuilder &_fbb, const app_rulesetT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _gaia_application = _o->gaia_application.empty() ? 0 : _fbb.CreateString(_o->gaia_application);
  auto _gaia_ruleset = _o->gaia_ruleset.empty() ? 0 : _fbb.CreateString(_o->gaia_ruleset);
