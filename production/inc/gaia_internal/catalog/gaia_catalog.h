...
public:
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<rule_relationship_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<rule_relationship_t, uint8_t> type;
        static gaia::expressions::expression_t<rule_relationship_t, gaia_relationship_t> relationship;
        static gaia::expressions::expression_t<rule_relationship_t, gaia_rule_t> rule;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<rule_relationship_t, gaia::common::gaia_id_t> rule_relationship_t::expr_<unused_t>::gaia_id{&rule_relationship_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<rule_relationship_t, uint8_t> rule_relationship_t::expr_<unused_t>::type{&rule_relationship_t::type};
template<class unused_t> gaia::expressions::expression_t<rule_relationship_t, gaia_relationship_t> rule_relationship_t::expr_<unused_t>::relationship{&rule_relationship_t::relationship};
template<class unused_t> gaia::expressions::expression_t<rule_relationship_t, gaia_rule_t> rule_relationship_t::expr_<unused_t>::rule{&rule_relationship_t::rule};
...
public:
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<rule_field_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<rule_field_t, uint8_t> type;
        static gaia::expressions::expression_t<rule_field_t, bool> active;
        static gaia::expressions::expression_t<rule_field_t, gaia_field_t> field;
        static gaia::expressions::expression_t<rule_field_t, gaia_rule_t> rule;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<rule_field_t, gaia::common::gaia_id_t> rule_field_t::expr_<unused_t>::gaia_id{&rule_field_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<rule_field_t, uint8_t> rule_field_t::expr_<unused_t>::type{&rule_field_t::type};
template<class unused_t> gaia::expressions::expression_t<rule_field_t, bool> rule_field_t::expr_<unused_t>::active{&rule_field_t::active};
template<class unused_t> gaia::expressions::expression_t<rule_field_t, gaia_field_t> rule_field_t::expr_<unused_t>::field{&rule_field_t::field};
template<class unused_t> gaia::expressions::expression_t<rule_field_t, gaia_rule_t> rule_field_t::expr_<unused_t>::rule{&rule_field_t::rule};
...
public:
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<rule_table_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<rule_table_t, uint8_t> type;
        static gaia::expressions::expression_t<rule_table_t, bool> anchor;
        static gaia::expressions::expression_t<rule_table_t, gaia_table_t> table;
        static gaia::expressions::expression_t<rule_table_t, gaia_rule_t> rule;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<rule_table_t, gaia::common::gaia_id_t> rule_table_t::expr_<unused_t>::gaia_id{&rule_table_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<rule_table_t, uint8_t> rule_table_t::expr_<unused_t>::type{&rule_table_t::type};
template<class unused_t> gaia::expressions::expression_t<rule_table_t, bool> rule_table_t::expr_<unused_t>::anchor{&rule_table_t::anchor};
template<class unused_t> gaia::expressions::expression_t<rule_table_t, gaia_table_t> rule_table_t::expr_<unused_t>::table{&rule_table_t::table};
template<class unused_t> gaia::expressions::expression_t<rule_table_t, gaia_rule_t> rule_table_t::expr_<unused_t>::rule{&rule_table_t::rule};
...
public:
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<ruleset_database_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<ruleset_database_t, gaia_ruleset_t> ruleset;
        static gaia::expressions::expression_t<ruleset_database_t, gaia_database_t> database;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<ruleset_database_t, gaia::common::gaia_id_t> ruleset_database_t::expr_<unused_t>::gaia_id{&ruleset_database_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<ruleset_database_t, gaia_ruleset_t> ruleset_database_t::expr_<unused_t>::ruleset{&ruleset_database_t::ruleset};
template<class unused_t> gaia::expressions::expression_t<ruleset_database_t, gaia_database_t> ruleset_database_t::expr_<unused_t>::database{&ruleset_database_t::database};
...
public:
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<app_ruleset_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<app_ruleset_t, bool> active_on_startup;
        static gaia::expressions::expression_t<app_ruleset_t, gaia_ruleset_t> ruleset;
        static gaia::expressions::expression_t<app_ruleset_t, gaia_application_t> application;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<app_ruleset_t, gaia::common::gaia_id_t> app_ruleset_t::expr_<unused_t>::gaia_id{&app_ruleset_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<app_ruleset_t, bool> app_ruleset_t::expr_<unused_t>::active_on_startup{&app_ruleset_t::active_on_startup};
template<class unused_t> gaia::expressions::expression_t<app_ruleset_t, gaia_ruleset_t> app_ruleset_t::expr_<unused_t>::ruleset{&app_ruleset_t::ruleset};
template<class unused_t> gaia::expressions::expression_t<app_ruleset_t, gaia_application_t> app_ruleset_t::expr_<unused_t>::application{&app_ruleset_t::application};
...
public:
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<app_database_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<app_database_t, gaia_database_t> database;
        static gaia::expressions::expression_t<app_database_t, gaia_application_t> application;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<app_database_t, gaia::common::gaia_id_t> app_database_t::expr_<unused_t>::gaia_id{&app_database_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<app_database_t, gaia_database_t> app_database_t::expr_<unused_t>::database{&app_database_t::database};
template<class unused_t> gaia::expressions::expression_t<app_database_t, gaia_application_t> app_database_t::expr_<unused_t>::application{&app_database_t::application};
...
public:
    typedef gaia::direct_access::reference_container_t<app_ruleset_t> app_rulesets_list_t;
    typedef gaia::direct_access::reference_container_t<app_database_t> app_databases_list_t;
    ...
    template<class unused_t>
    struct expr_ {
        static gaia::expressions::expression_t<gaia_application_t, gaia::common::gaia_id_t> gaia_id;
        static gaia::expressions::expression_t<gaia_application_t, const char*> name;
        static gaia::expressions::expression_t<gaia_application_t, gaia_application_t::app_rulesets_list_t> app_rulesets;
        static gaia::expressions::expression_t<gaia_application_t, gaia_application_t::app_databases_list_t> app_databases;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<gaia_application_t, gaia::common::gaia_id_t> gaia_application_t::expr_<unused_t>::gaia_id{&gaia_application_t::gaia_id};
template<class unused_t> gaia::expressions::expression_t<gaia_application_t, const char*> gaia_application_t::expr_<unused_t>::name{&gaia_application_t::name};
template<class unused_t> gaia::expressions::expression_t<gaia_application_t, gaia_application_t::app_rulesets_list_t> gaia_application_t::expr_<unused_t>::app_rulesets{&gaia_application_t::app_rulesets};
template<class unused_t> gaia::expressions::expression_t<gaia_application_t, gaia_application_t::app_databases_list_t> gaia_application_t::expr_<unused_t>::app_databases{&gaia_application_t::app_databases};
...
public:
    typedef gaia::direct_access::reference_container_t<rule_relationship_t> rule_relationships_list_t;
    typedef gaia::direct_access::reference_container_t<rule_field_t> rule_fields_list_t;
    typedef gaia::direct_access::reference_container_t<rule_table_t> rule_tables_list_t;
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_rule_t, gaia_rule_t::rule_relationships_list_t> rule_relationships;
        static gaia::expressions::expression_t<gaia_rule_t, gaia_rule_t::rule_fields_list_t> rule_fields;
        static gaia::expressions::expression_t<gaia_rule_t, gaia_rule_t::rule_tables_list_t> rule_tables;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<gaia_rule_t, gaia_rule_t::rule_relationships_list_t> gaia_rule_t::expr_<unused_t>::rule_relationships{&gaia_rule_t::rule_relationships};
template<class unused_t> gaia::expressions::expression_t<gaia_rule_t, gaia_rule_t::rule_fields_list_t> gaia_rule_t::expr_<unused_t>::rule_fields{&gaia_rule_t::rule_fields};
template<class unused_t> gaia::expressions::expression_t<gaia_rule_t, gaia_rule_t::rule_tables_list_t> gaia_rule_t::expr_<unused_t>::rule_tables{&gaia_rule_t::rule_tables};
...
public:
    typedef gaia::direct_access::reference_container_t<ruleset_database_t> ruleset_databases_list_t;
    typedef gaia::direct_access::reference_container_t<app_ruleset_t> app_rulesets_list_t;
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_ruleset_t, gaia_ruleset_t::ruleset_databases_list_t> ruleset_databases;
        static gaia::expressions::expression_t<gaia_ruleset_t, gaia_ruleset_t::app_rulesets_list_t> app_rulesets;
...
template<class unused_t> gaia::expressions::expression_t<gaia_ruleset_t, gaia_ruleset_t::ruleset_databases_list_t> gaia_ruleset_t::expr_<unused_t>::ruleset_databases{&gaia_ruleset_t::ruleset_databases};
template<class unused_t> gaia::expressions::expression_t<gaia_ruleset_t, gaia_ruleset_t::app_rulesets_list_t> gaia_ruleset_t::expr_<unused_t>::app_rulesets{&gaia_ruleset_t::app_rulesets};
...
public:
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_relationship_t, const char*> hash;
        ...
        static gaia::expressions::expression_t<gaia_relationship_t, gaia_relationship_t::rule_relationships_list_t> rule_relationships;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<gaia_relationship_t, const char*> gaia_relationship_t::expr_<unused_t>::hash{&gaia_relationship_t::hash};
...
template<class unused_t> gaia::expressions::expression_t<gaia_relationship_t, gaia_relationship_t::rule_relationships_list_t> gaia_relationship_t::expr_<unused_t>::rule_relationships{&gaia_relationship_t::rule_relationships};
...
public:
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_field_t, const char*> hash;
        static gaia::expressions::expression_t<gaia_field_t, gaia_table_t> table;
        static gaia::expressions::expression_t<gaia_field_t, gaia_field_t::rule_fields_list_t> rule_fields;
    };
    using expr = expr_<void>;
private:
...
template<class unused_t> gaia::expressions::expression_t<gaia_field_t, const char*> gaia_field_t::expr_<unused_t>::hash{&gaia_field_t::hash};
...
template<class unused_t> gaia::expressions::expression_t<gaia_field_t, gaia_field_t::rule_fields_list_t> gaia_field_t::expr_<unused_t>::rule_fields{&gaia_field_t::rule_fields};
...
public:
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_table_t, const char*> hash;
        static gaia::expressions::expression_t<gaia_table_t, gaia_database_t> database;
        static gaia::expressions::expression_t<gaia_table_t, gaia_table_t::rule_tables_list_t> rule_tables;
...
template<class unused_t> gaia::expressions::expression_t<gaia_table_t, const char*> gaia_table_t::expr_<unused_t>::hash{&gaia_table_t::hash};
...
template<class unused_t> gaia::expressions::expression_t<gaia_table_t, gaia_table_t::rule_tables_list_t> gaia_table_t::expr_<unused_t>::rule_tables{&gaia_table_t::rule_tables};
...
public:
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_database_t, const char*> hash;
        static gaia::expressions::expression_t<gaia_database_t, gaia_database_t::ruleset_databases_list_t> ruleset_databases;
        static gaia::expressions::expression_t<gaia_database_t, gaia_database_t::app_databases_list_t> app_databases;
...
template<class unused_t> gaia::expressions::expression_t<gaia_database_t, const char*> gaia_database_t::expr_<unused_t>::hash{&gaia_database_t::hash};
template<class unused_t> gaia::expressions::expression_t<gaia_database_t, gaia_database_t::ruleset_databases_list_t> gaia_database_t::expr_<unused_t>::ruleset_databases{&gaia_database_t::ruleset_databases};
template<class unused_t> gaia::expressions::expression_t<gaia_database_t, gaia_database_t::app_databases_list_t> gaia_database_t::expr_<unused_t>::app_databases{&gaia_database_t::app_databases};
