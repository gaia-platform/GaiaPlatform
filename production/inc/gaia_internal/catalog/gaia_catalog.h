...
struct gaia_table_t : public gaia::direct_access::gaia_object_t<c_gaia_type_gaia_table, gaia_table_t, internal::gaia_table, internal::gaia_tableT, c_num_gaia_table_ptrs> {
    ...
    typedef gaia::direct_access::reference_chain_container_t<gaia_table_t, gaia_index_t, c_parent_gaia_table_gaia_index, c_first_gaia_table_gaia_index, c_next_gaia_table_gaia_index> gaia_index_list_t;
    ...
    gaia_index_list_t gaia_index_list() const {
        return gaia_index_list_t(gaia_id());
    }
private:
...
typedef gaia::direct_access::gaia_writer_t<c_gaia_type_gaia_index, gaia_index_t, internal::gaia_index, internal::gaia_indexT, c_num_gaia_index_ptrs> gaia_index_writer;
struct gaia_index_t : public gaia::direct_access::gaia_object_t<c_gaia_type_gaia_index, gaia_index_t, internal::gaia_index, internal::gaia_indexT, c_num_gaia_index_ptrs> {
    gaia_index_t() : gaia_object_t("gaia_index_t") {}
    const char* name() const {return GET_STR(name);}
    ...
    static gaia::direct_access::gaia_container_t<c_gaia_type_gaia_index, gaia_index_t>& list() {
        static gaia::direct_access::gaia_container_t<c_gaia_type_gaia_index, gaia_index_t> list;
        return list;
    }
private:
    friend struct gaia_object_t<c_gaia_type_gaia_index, gaia_index_t, internal::gaia_index, internal::gaia_indexT, c_num_gaia_index_ptrs>;
    explicit gaia_index_t(gaia::common::gaia_id_t id) : gaia_object_t(id, "gaia_index_t") {}
};
