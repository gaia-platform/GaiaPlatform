...
public:
    ...
    struct expr_ {
        ...
        static gaia::expressions::expression_t<gaia_index_t, const char*> hash;
...
template<class unused_t> gaia::expressions::expression_t<gaia_index_t, const char*> gaia_index_t::expr_<unused_t>::hash{&gaia_index_t::hash};
...
public:
    ...
    static const char* gaia_typename();
    static gaia::common::gaia_id_t insert_row(const char* name, bool active_on_startup);
