...
typedef gaia_writer_t<4294967291,gaia_database_t,gaia_database,gaia_databaseT,c_num_gaia_database_ptrs> gaia_database_writer;
struct gaia_database_t : public gaia_object_t<4294967291,gaia_database_t,gaia_database,gaia_databaseT,c_num_gaia_database_ptrs> {
    ...
    static gaia_container_t<4294967291, gaia_database_t>& list() {
        static gaia_container_t<4294967291, gaia_database_t> list;
        return list;
    }
...
private:
    friend struct gaia_object_t<4294967291, gaia_database_t, gaia_database, gaia_databaseT, c_num_gaia_database_ptrs>;
    gaia_database_t(gaia_id_t id) : gaia_object_t(id, "gaia_database_t") {
        m_gaia_table_list.set_outer(gaia_id());
    }
};

typedef gaia_writer_t<4294967292,gaia_ruleset_t,gaia_ruleset,gaia_rulesetT,c_num_gaia_ruleset_ptrs> gaia_ruleset_writer;
struct gaia_ruleset_t : public gaia_object_t<4294967292,gaia_ruleset_t,gaia_ruleset,gaia_rulesetT,c_num_gaia_ruleset_ptrs> {
    ...
    static gaia_container_t<4294967292, gaia_ruleset_t>& list() {
        static gaia_container_t<4294967292, gaia_ruleset_t> list;
        return list;
    }
...
private:
    friend struct gaia_object_t<4294967292, gaia_ruleset_t, gaia_ruleset, gaia_rulesetT, c_num_gaia_ruleset_ptrs>;
    gaia_ruleset_t(gaia_id_t id) : gaia_object_t(id, "gaia_ruleset_t") {
        m_gaia_rule_list.set_outer(gaia_id());
    }
};

typedef gaia_writer_t<4294967293,gaia_rule_t,gaia_rule,gaia_ruleT,c_num_gaia_rule_ptrs> gaia_rule_writer;
struct gaia_rule_t : public gaia_object_t<4294967293,gaia_rule_t,gaia_rule,gaia_ruleT,c_num_gaia_rule_ptrs> {
    ...
    static gaia_container_t<4294967293, gaia_rule_t>& list() {
        static gaia_container_t<4294967293, gaia_rule_t> list;
        return list;
    }
private:
    friend struct gaia_object_t<4294967293, gaia_rule_t, gaia_rule, gaia_ruleT, c_num_gaia_rule_ptrs>;
    gaia_rule_t(gaia_id_t id) : gaia_object_t(id, "gaia_rule_t") {
    }
};

typedef gaia_writer_t<4294967294,gaia_table_t,gaia_table,gaia_tableT,c_num_gaia_table_ptrs> gaia_table_writer;
struct gaia_table_t : public gaia_object_t<4294967294,gaia_table_t,gaia_table,gaia_tableT,c_num_gaia_table_ptrs> {
    ...
    using gaia_object_t::insert_row;
    static gaia_id_t insert_row(const char* name, uint32_t type, bool is_system, uint8_t trim_action, uint64_t max_rows, uint64_t max_size, uint64_t max_seconds, const char* binary_schema) {
        flatbuffers::FlatBufferBuilder b(c_flatbuffer_builder_size);
        b.Finish(Creategaia_tableDirect(b, name, type, is_system, trim_action, max_rows, max_size, max_seconds, binary_schema));
        return gaia_object_t::insert_row(b);
    }
    gaia_database_t gaia_database() {
        return gaia_database_t::get(this->references()[c_parent_gaia_table_gaia_database]);
    }
    static gaia_container_t<4294967294, gaia_table_t>& list() {
        static gaia_container_t<4294967294, gaia_table_t> list;
        return list;
    }
...
private:
    friend struct gaia_object_t<4294967294, gaia_table_t, gaia_table, gaia_tableT, c_num_gaia_table_ptrs>;
...
typedef gaia_writer_t<4294967295,gaia_field_t,gaia_field,gaia_fieldT,c_num_gaia_field_ptrs> gaia_field_writer;
struct gaia_field_t : public gaia_object_t<4294967295,gaia_field_t,gaia_field,gaia_fieldT,c_num_gaia_field_ptrs> {
    ...
    static gaia_container_t<4294967295, gaia_field_t>& list() {
        static gaia_container_t<4294967295, gaia_field_t> list;
        return list;
    }
private:
    friend struct gaia_object_t<4294967295, gaia_field_t, gaia_field, gaia_fieldT, c_num_gaia_field_ptrs>;
