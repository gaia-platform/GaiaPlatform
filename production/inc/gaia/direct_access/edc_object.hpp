 ...
 *
 * @tparam container_type an integer (gaia_type_t) uniquely identifying the flatbuffer table type
...
public:
     ...
     * by the container_type, and that type must match the type of the identified object.
     *
     * @param id the gaia_id_t of a specific database object, of type container_type
     */
...
protected:
    ...
    /**
     * Ensure the type requested by the gaia_id_t matches container_type. If the passed in
