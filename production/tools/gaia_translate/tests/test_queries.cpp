...
protected:
    ...
    void mini_pop()
    {
        ...
        course_waynetype::get(course_waynetype::insert_row("cou001", "math101", 3));
        course_waynetype::get(course_waynetype::insert_row("cou002", "math201", 4));
        course_waynetype::get(course_waynetype::insert_row("cou003", "eng101", 3));
        course_waynetype::get(course_waynetype::insert_row("cou004", "sci101", 3));
        course_waynetype::get(course_waynetype::insert_row("cou005", "math301", 5));
        ...
        registration_waynetype::insert_row("reg003", "stu002", "cou001", c_status_eligible, c_grade_b);
        registration_waynetype::insert_row("reg004", "stu002", "cou003", c_status_eligible, c_grade_c);
        registration_waynetype::insert_row("reg005", "stu002", "cou004", c_status_eligible, c_grade_d);
        registration_waynetype::insert_row("reg006", "stu003", "cou005", c_status_pending, c_grade_none);
        registration_waynetype::insert_row("reg007", "stu003", "cou002", c_status_eligible, c_grade_c);
        registration_waynetype::insert_row("reg008", "stu003", "cou001", c_status_eligible, c_grade_b);
    ...
    void populate_db()
    {
        ...
        // These must be DAC objects. They have insert() methods.
        course_1 = course_waynetype::get(course_waynetype::insert_row("cou001", "math101", 3));
        course_2 = course_waynetype::get(course_waynetype::insert_row("cou002", "math201", 4));
        course_3 = course_waynetype::get(course_waynetype::insert_row("cou003", "eng101", 3));
        course_4 = course_waynetype::get(course_waynetype::insert_row("cou004", "sci101", 3));
        course_5 = course_waynetype::get(course_waynetype::insert_row("cou005", "math301", 5));

        reg_1 = registration_waynetype::get(registration_waynetype::insert_row("reg001", "stu001", "cou002", c_status_pending, c_grade_none));
        // These are gaia_id_t.
        registration_waynetype::insert_row("reg002", "stu001", "cou004", c_status_eligible, c_grade_c);
        registration_waynetype::insert_row("reg003", "stu002", "cou001", c_status_eligible, c_grade_b);
        registration_waynetype::insert_row("reg004", "stu002", "cou003", c_status_eligible, c_grade_c);
        ...
        registration_waynetype::insert_row("reg007", "stu003", "cou002", c_status_eligible, c_grade_c);
        registration_waynetype::insert_row("reg008", "stu003", "cou001", c_status_eligible, c_grade_b);
        registration_waynetype::insert_row("reg009", "stu003", "cou003", c_status_eligible, c_grade_b);
        registration_waynetype::insert_row("reg00A", "stu003", "cou004", c_status_eligible, c_grade_a);
        registration_waynetype::insert_row("reg00B", "stu004", "cou004", c_status_eligible, c_grade_b);
        registration_waynetype::insert_row("reg00C", "stu004", "cou001", c_status_eligible, c_grade_b);
        registration_waynetype::insert_row("reg00D", "stu005", "cou002", c_status_pending, c_grade_none);
        registration_waynetype::insert_row("reg00E", "stu005", "cou003", c_status_eligible, c_grade_c);
        registration_waynetype::insert_row("reg00F", "stu005", "cou004", c_status_eligible, c_grade_a);
        registration_waynetype::insert_row("reg00G", "stu005", "cou001", c_status_eligible, c_grade_b);

        // These are gaia_id_t.
        auto prereq_1 = prereq_waynetype::get(prereq_waynetype::insert_row("pre001", c_grade_c));
        auto prereq_2 = prereq_waynetype::get(prereq_waynetype::insert_row("pre002", c_grade_d));
        auto prereq_3 = prereq_waynetype::get(prereq_waynetype::insert_row("pre003", c_grade_c));
        auto prereq_4 = prereq_waynetype::get(prereq_waynetype::insert_row("pre004", c_grade_c));
...
TEST_F(test_queries_code, basic_implicit_navigation)
{
    ...
    gaia::db::begin_transaction();
    auto s = student_waynetype::list().where(surname == "Richard").begin();
    auto sw = s->writer();
    sw.age = 46;
    sw.update_row();
    gaia::db::commit_transaction();
...
TEST_F(test_queries_code, implicit_navigation_fork)
{
    ...
    gaia::db::begin_transaction();
    auto r = registration_waynetype::list().where(reg_id == "reg003").begin();
    auto rw = r->writer();
    rw.grade = c_grade_c;
    rw.update_row();
    gaia::db::commit_transaction();
...
TEST_F(test_queries_code, new_registration)
{
    ...
    auto reg = registration_waynetype::insert_row("reg00H", "stu001", "cou005", c_status_pending, c_grade_none);

    // Russell registers for math201.
    reg = registration_waynetype::insert_row("reg00I", "stu002", "cou002", c_status_pending, c_grade_none);

    // Rachael register for eng101.
    reg = registration_waynetype::insert_row("reg00K", "stu004", "cou003", c_status_pending, c_grade_none);

    // Renee registers for math301
    reg = registration_waynetype::insert_row("reg00L", "stu005", "cou005", c_status_pending, c_grade_none);
...
TEST_F(test_queries_code, sum_of_ages)
{
    ...
    auto student = student_waynetype::get(student_waynetype::insert_row("stu006", "Paul", 62, 4, 3.3));
...
TEST_F(test_queries_code, sum_of_hours)
{
    ...
    registration_waynetype::insert_row("reg00H", "stu001", "cou005", c_status_pending, c_grade_none);
...
TEST_F(test_queries_code, nomatch_stmt3)
{
    ...
    auto student = student_waynetype::get(student_waynetype::insert_row("stu006", "Paul", 62, 4, 3.3));
    registration_waynetype::insert_row("reg00H", "stu006", nullptr, c_status_eligible, c_grade_c);
...
TEST_F(test_queries_code, nomatch_function_query)
{
    ...
    auto student = student_waynetype::get(student_waynetype::insert_row("stu006", "Paul", 62, 4, 3.3));
    auto registration = registration_waynetype::insert_row("reg00H", "stu006", "cou001", c_status_eligible, c_grade_c);
    registration = registration_waynetype::insert_row("reg00I", "stu006", "cou002", c_status_eligible, c_grade_d);
...
TEST_F(test_queries_code, one_to_one)
{
    ...
    auto parents_1 = parents_waynetype::get(parents_waynetype::insert_row("Lawrence", "Elizabeth"));
    auto parents_2 = parents_waynetype::get(parents_waynetype::insert_row("Clarence", "Pauline"));
    auto parents_3 = parents_waynetype::get(parents_waynetype::insert_row("George", "Irvie"));
