...
constexpr uint32_t c_gaia_type_greetings = 12u;
constexpr int c_greetings_parent_name_1 = 0;
constexpr int c_greetings_next_name_1 = 1;
constexpr int c_greetings_parent_name_M = 2;
constexpr int c_greetings_next_name_M = 3;

// Constants contained in the names object.
constexpr uint32_t c_gaia_type_names = 11u;
constexpr int c_names_first_preferred_greeting = 0;
constexpr int c_names_first_greetings = 1;
...
struct names_t : public gaia::direct_access::edc_object_t<c_gaia_type_names, names_t, internal::names, internal::namesT> {
    ...
    greetings_ref_t preferred_greeting() const;

    greetings_list_t greetings() const {
        return greetings_list_t(gaia_id(), c_names_first_greetings, c_greetings_next_name_M);
    }
    ...
    struct expr_ {
        ...
        static gaia::direct_access::expression_t<names_t, greetings_ref_t> preferred_greeting;
...
{
    names_ref_t() = delete;
    names_ref_t(gaia::common::gaia_id_t parent, gaia::common::gaia_id_t id, size_t child_slot);
    void disconnect();
    void connect(gaia::common::gaia_id_t id);
    void connect(const names_t& object);
};
...
template<class unused_t> gaia::direct_access::expression_t<names_t, greetings_ref_t> names_t::expr_<unused_t>::preferred_greeting{&names_t::preferred_greeting};
...
namespace names_expr {
    ...
    static auto& preferred_greeting = names_t::expr::preferred_greeting;
...
struct greetings_t : public gaia::direct_access::edc_object_t<c_gaia_type_greetings, greetings_t, internal::greetings, internal::greetingsT> {
    ...
    names_ref_t name_1() const;

    names_ref_t name_M() const;
    ...
    struct expr_ {
        ...
        static gaia::direct_access::expression_t<greetings_t, names_ref_t> name_1;
        static gaia::direct_access::expression_t<greetings_t, names_ref_t> name_M;
    };
    using expr = expr_<void>;
...
struct greetings_ref_t : public greetings_t, public direct_access::edc_ref_t
{
    ...
    greetings_ref_t(gaia::common::gaia_id_t parent, gaia::common::gaia_id_t child, size_t child_slot);
    void disconnect();
    void connect(gaia::common::gaia_id_t id);
    void connect(const greetings_t& object);
};
...
template<class unused_t> gaia::direct_access::expression_t<greetings_t, names_ref_t> greetings_t::expr_<unused_t>::name_1{&greetings_t::name_1};
template<class unused_t> gaia::direct_access::expression_t<greetings_t, names_ref_t> greetings_t::expr_<unused_t>::name_M{&greetings_t::name_M};

namespace greetings_expr {
    static auto& greeting = greetings_t::expr::greeting;
    static auto& name_1 = greetings_t::expr::name_1;
    static auto& name_M = greetings_t::expr::name_M;
};
