...
struct names_t : public gaia::direct_access::edc_object_t<c_gaia_type_names, names_t, internal::names, internal::namesT> {
    ...
    greetings_ref_t greetings() const;
    ...
    struct expr_ {
        ...
        static gaia::direct_access::expression_t<names_t, greetings_ref_t> greetings;
    };
...
template<class unused_t> gaia::direct_access::expression_t<names_t, greetings_ref_t> names_t::expr_<unused_t>::greetings{&names_t::greetings};
...
struct greetings_t : public gaia::direct_access::edc_object_t<c_gaia_type_greetings, greetings_t, internal::greetings, internal::greetingsT> {
    ...
    struct expr_ {
        ...
        static gaia::direct_access::expression_t<greetings_t, names_ref_t> names;
    };
    using expr = expr_<void>;
...
template<class unused_t> gaia::direct_access::expression_t<greetings_t, names_ref_t> greetings_t::expr_<unused_t>::names{&greetings_t::names};
