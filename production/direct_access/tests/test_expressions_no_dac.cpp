...
TEST_F(test_expressions_no_dac, expr_add)
{
    ...
    int64_t i64 = 500;
    auto i64_value = value_accessor_t<context_t, int64_t>(i64);

    auto add_expression = i64_value + 100;
    ASSERT_EQ(add_expression(g_bind), i64 + 100);

    // yoda
    auto add_expression2 = 100 + i64_value;
...
TEST_F(test_expressions_no_dac, expr_sub)
{
    ...
    auto sub_expression = i64_value - 100;
    ASSERT_EQ(sub_expression(g_bind), i64 - 100);

    auto sub_expression2 = 100 - i64_value;
...
TEST_F(test_expressions_no_dac, expr_mul)
{
    ...
    auto mul_expression = i64_value * 2;
    ASSERT_EQ(mul_expression(g_bind), i64 * 2);

    auto mul_expression2 = 0.25 * i64_value;
...
TEST_F(test_expressions_no_dac, expr_div)
{
    ...
    auto div_expression = i64_value / 2;
    ASSERT_EQ(div_expression(g_bind), i64 / 2);

    auto div_expression2 = 2 / i64_value;
