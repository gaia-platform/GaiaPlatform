...
class gaia_set_iterator_test : public db_test_base_t {
public:
    // TODO: replace these typedefs with gaia_set_iterator_t types.
...
protected:
    ...
    // TODO: modify the following functions to insert/access set iterators
    // instead of regular Gaia iterators.
...
TEST_F(gaia_set_iterator_test, iterator_traits) {
...
TEST_F(gaia_set_iterator_test, pre_incrementable) {
    const int LOOPS = 10;
...
TEST_F(gaia_set_iterator_test, equality_comparable) {
    auto_transaction_t tx;
    insert_records(3);
...
TEST_F(gaia_set_iterator_test, not_equal) {
    auto_transaction_t tx;
    insert_records(3);
...
// trait?
TEST_F(gaia_set_iterator_test, reference_convertibility) {
...
TEST_F(gaia_set_iterator_test, dereferenceable_rvalue) {
    auto_transaction_t tx;
    insert_records(1);
...
TEST_F(gaia_set_iterator_test, dereferenceable_equality) {
    auto_transaction_t tx;
    insert_records(1);
...
TEST_F(gaia_set_iterator_test, deref_arrow) {
    auto_transaction_t tx;
    insert_records(1);
...
TEST_F(gaia_set_iterator_test, pre_inc_and_post_inc) {
    auto_transaction_t tx;
    insert_records(3);
...
TEST_F(gaia_set_iterator_test, deref_and_postinc) {
    auto_transaction_t tx;
    insert_records(3);
...
TEST_F(gaia_set_iterator_test, default_constructible) {
...
// underlying sequence?
TEST_F(gaia_set_iterator_test, equality_and_inequality_in_sequence) {
    auto_transaction_t tx;
    insert_records(10);
...
TEST_F(gaia_set_iterator_test, post_increment) {
    auto_transaction_t tx;
    insert_records(3);
...
// guarantee.
TEST_F(gaia_set_iterator_test, multipass_guarantee) {
    const int LENGTH = 10;
    const int PASSES = 10;
