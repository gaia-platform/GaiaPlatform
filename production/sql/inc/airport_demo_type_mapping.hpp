...
inline Datum airport_get_gaia_id(const void *root_object) {
...
inline Datum airline_get_gaia_id(const void *root_object) {
...
inline Datum route_get_gaia_id(const void *root_object) {
