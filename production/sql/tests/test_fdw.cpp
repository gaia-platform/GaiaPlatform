...
{
    gaia_id_t airports_table_id = create_table("airports", airports_table_fields);
    gaia_id_t airlines_table_id = create_table("airlines", airlines_table_fields);
    gaia_id_t routes_table_id = create_table("routes", routes_table_fields);

    cout << "Airports table id: " << airports_table_id << endl;
    cout << "Airlines table id: " << airlines_table_id << endl;
    cout << "Routes table id: " << routes_table_id << endl;
