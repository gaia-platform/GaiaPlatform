...
gaia::db::locators_t* gaia::db::get_locators()
{
    ...
    retail_assert(gaia::db::server::s_shared_locators.is_set(), "Server locators segment is unmapped!");
...
gaia::db::counters_t* gaia::db::get_counters()
{
    ...
    retail_assert(gaia::db::server::s_shared_counters.is_set(), "Server counters segment is unmapped!");
...
gaia::db::data_t* gaia::db::get_data()
{
    ...
    retail_assert(gaia::db::server::s_shared_data.is_set(), "Server data segment is unmapped!");
...
gaia::db::id_index_t* gaia::db::get_id_index()
{
    ...
    retail_assert(gaia::db::server::s_shared_id_index.is_set(), "Server id_index segment is unmapped!");
