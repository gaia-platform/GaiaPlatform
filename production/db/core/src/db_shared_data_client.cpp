...
{
    if (gaia::db::client::s_private_locators.is_closed())
    {
...
gaia::db::counters_t* gaia::db::get_counters()
{
    ...
    if (gaia::db::client::s_shared_counters.is_closed())
    {
...
gaia::db::data_t* gaia::db::get_data()
{
    ...
    if (gaia::db::client::s_shared_data.is_closed())
    {
        throw no_active_session();
    }
...
gaia::db::id_index_t* gaia::db::get_id_index()
{
    ...
    if (gaia::db::client::s_shared_id_index.is_closed())
    {
        throw no_active_session();
    }
