...
constexpr size_t c_num_initial_rows = 50000;
...
public:
    ...
    void SetUp() override
    {
        ...
        g_timer_t::log_duration(begin, "insertion");
    }
};
...
TEST_F(test_index_scan, query_single_match)
{
    ...
    g_timer_t::log_duration(begin, "find index()");
    ...
    g_timer_t::log_duration(begin, "range index()");
    ...
    g_timer_t::log_duration(begin, "hash index()");
