...
TEST(memory_manager, stack_allocator)
{
    ...
    address_offset_t first_allocation_offset = stack_allocator->allocate(
        c_first_slot_id, c_first_old_offset, c_first_allocation_size);
    ...
    address_offset_t second_allocation_offset = stack_allocator->allocate(
        c_second_slot_id, c_second_old_offset, c_second_allocation_size);
    ...
    address_offset_t third_allocation_offset = stack_allocator->allocate(
        c_third_slot_id, c_third_old_offset, c_third_allocation_size);
    ...
    address_offset_t fourth_allocation_offset = stack_allocator->allocate(
        c_fourth_slot_id, c_fourth_old_offset, c_fourth_allocation_size);
    ...
    address_offset_t fifth_allocation_offset = stack_allocator->allocate(
        c_fifth_slot_id, c_fifth_old_offset, c_fifth_allocation_size);
    ...
    read_stack_allocator->load(memory, memory_offset, c_stack_allocator_memory_size);
