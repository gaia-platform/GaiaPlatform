...
public:
    ...
    void get_field_cache(gaia_id_t table_id, auto_field_cache_t& auto_field_cache);
    ...
    bool remove_field_cache(gaia_id_t table_id);
    ...
    bool set_field_cache(gaia_id_t table_id, const field_cache_t* field_cache);
