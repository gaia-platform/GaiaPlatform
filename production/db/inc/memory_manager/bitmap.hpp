...
uint64_t count_set_bits(uint64_t* bitmap, uint64_t bitmap_size, uint64_t end_limit_bit_index = c_max_bit_index);
...
uint64_t find_first_unset_bit(uint64_t* bitmap, uint64_t bitmap_size, uint64_t end_limit_bit_index = c_max_bit_index);
