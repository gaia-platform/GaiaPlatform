...
PYBIND11_MODULE(se_mock, m)
{
    m.doc() = "Python wrapper over Gaia COW storage engine mock.";
    ...
    register_exception<gaia::db::dependent_edges_exist>(m, "dependent_edges_exist");
