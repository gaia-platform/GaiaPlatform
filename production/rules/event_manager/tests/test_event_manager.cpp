 ...
 *
 * TODO: Transaction events are out of scope because we haven't nailed down exactly what
 * data we would send to the rule.
...
void rule10(const rule_context_t* context)
{
    ...
    // TODO: This will cause a cycle.  If we handle cycles in the rules engine scheduler then we can reinstate
    // this test.
...
// TODO: Event logging is not implemented since we haven't implemented trim functionality in the database yet.
