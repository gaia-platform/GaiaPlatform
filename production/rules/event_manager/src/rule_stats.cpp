...
const char* rule_stats_t::c_cumulative_rule_stats = "[thread load: {:8.2f} %]{:6}{:6}{:6}{:6}{:6}{:6}{:10.2f} ms{:10.2f} ms{:10.2f} ms{:10.2f} ms";
...
template void rule_stats_t::log_(const char* format, float worker_thread_utilization);
