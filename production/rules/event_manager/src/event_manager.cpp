...
bool event_manager_t::log_event(gaia_base * row, event_type type, event_mode mode)
{
    return false;
}

bool event_manager_t::subscribe_rule(gaia::api::gaia_type_t gaia_type, 
    event_type type, gaia::rules::rule_binding_t& rule_binding)
{
    return false;
}
...
bool event_manager_t::unsubscribe_rule(event_type type, 
...
bool gaia::events::log_table_event(gaia_base * row, event_type type, event_mode mode)
{
...
bool gaia::rules::subscribe_transaction_rule(event_type type, 
    gaia::rules::rule_binding_t& rule_binding)
{
...
bool gaia::rules::unsubscribe_transaction_rule(event_type type, 
    const gaia::rules::rule_binding_t& rule_binding)
{
