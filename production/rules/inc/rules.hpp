 ...
 * ruleset_name plus the rule_name must be unique across all the rules in the system.
 * 
 */
...
/**
 * Subscribes this rule to the specified transaction event.  Note that it
 * is legal to bind multiple different rules to the same event.  It is also possible
 * to bind the same rule to multiple different events.
 * 
...
/**
 * List all rules already subscribed to events.  Enable filtering on ruleset name,
 * gaia_type, and event_type.
 * 
