...
The focus of this framework is to provide for a comprehensive set
...
comments are supported.  Both are skipped over as if they were not there and
will not affect what is tested.  It is recommended that scenario tests start with
some manner of prolog like:
...
but still simple, description of the test.  If there is still some ambiguity as
to what the test does or information that can help the reader, the `this test...`
paragraph should be used to explain the test as succinctly as possible.
